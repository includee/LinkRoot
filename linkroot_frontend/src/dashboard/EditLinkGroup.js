...
export default function EditLinkGroup() {
  ...
  const handleAddLink = () => {
    setCurrentLinkGroup((prev) => ({
      ...prev,
      links: [...prev.links, { title: linkTitle, url: linkUrl }],
    }));
    setLinktitle("");
    setLinkurl("");
  };
  ...
  const deleteLink = (link_id) => {
    const updatedList = currentLinkGroup.links.filter(
      (item) => item.id !== link_id
    );
    setCurrentLinkGroup((prev) => ({
      ...prev,
      links: updatedList,
      ...
      return (
        <div className="h-full w-full flex">
          <div className="h-full w-full py-10">
            <div className="h-full w-1/2 mx-auto my-4 bg-white rounded-lg shadow-lg p-6">
              <div className="my-8">
                <div className="flex gap-5 items-center">
                  ...
                  {editingGroupName ? (
                    ...
                    <h1 className="text-xl font-semibold">
                      {currentLinkGroup.link_group.name}
                    </h1>
                  )}
              ...
              <div className="flex gap-3">
                ...
                >
                  Update <BiRefresh className="text-xl" />
                </button>
                <button
                ...
                >
                  Add Link <BiPlus className="text-xl" />
                </button>
              </div>
              ...
              <div className="my-5 flex flex-col gap-6">
                {currentLinkGroup.links.map((item) => (
                  <div
                    key={item.id}
                    className="p-3 rounded shadow border flex flex-col gap-2 bg-gray-50"
                  >
                    <div>
                      <h1>Title</h1>
  ...
  <div className='half-screen-container animate-wave'>
    <h1 className='text-3xl mb-10 font-extrabold text-center text-white'>{currentLinkGroup.link_group.name}</h1>
